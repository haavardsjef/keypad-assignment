...
class LedBoard:
    ...
    def __init__(self):
        ...
        self.ledInterface = LedInterface(Pin(16), Pin(20), Pin(21))
    ...
    def light_led(self, led, duration):
        ...
        pins."""
        print("Lighting led #", led, "for", duration, "seconds.")
    ...
    def power_up(self):
        ...
        print("Powering up!")
        self.ledInterface.loop([1, 2, 3], 1)
        self.ledInterface.loop([1, 2], 1)
        self.ledInterface.loop([1], 1)
    ...
    def success(self):
        ...
        self.ledInterface.loop([1, 2], 0.5)
        self.ledInterface.loop([3, 4], 0.5)
        self.ledInterface.loop([5, 6], 0.5)
        self.ledInterface.loop([1, 2, 3, 4, 5, 6], 1)
